...
export interface Battle {stage:number;time:number;phase:'ready'|'running'|'victory'|'defeat';units:Unit[];events:BattleEvent[];effects:Effect[];damage:Record<string,number>;dodges:Record<string,number>;}
